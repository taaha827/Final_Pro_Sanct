...
class AdminSitData(models.Model):
    filepath = models.CharField(db_column='FilePath', max_length=300)  # Field name made lowercase.
    website = models.CharField(db_column='Website', max_length=300)  # Field name made lowercase.
    ...
    category = models.CharField(db_column='Category', max_length=300)  # Field name made lowercase.
    percentage_off = models.CharField(db_column='Percentage_Off', max_length=300)  # Field name made lowercase.
    sales_type = models.CharField(db_column='Sales_Type', max_length=300)  # Field name made lowercase.
